...
public class QuantityMeasurementAppTest {
	...
	public void testConversion_FeetToInches() {
		assertEquals(12.0, Length.convert(1.0, LengthUnit.FEET, LengthUnit.INCH), EPSILON);
	}

	@Test
	public void testConversion_InchesToFeet() {
		assertEquals(2.0, Length.convert(24.0, LengthUnit.INCH, LengthUnit.FEET), EPSILON);
	}

	@Test
	public void testConversion_YardsToInches() {
		assertEquals(36.0, Length.convert(1.0, LengthUnit.YARDS, LengthUnit.INCH), EPSILON);
	}

	@Test
	public void testConversion_InchesToYards() {
		assertEquals(2.0, Length.convert(72.0, LengthUnit.INCH, LengthUnit.YARDS), EPSILON);
	}

	@Test
	public void testConversion_CentimetersToInches() {
		assertEquals(1.0, Length.convert(2.54, LengthUnit.CENTIMETERS, LengthUnit.INCH), EPSILON);
	}
	...
	public void testConversion_RoundTrip_PreservesValue() {
		...
		double toInches = Length.convert(original, LengthUnit.FEET, LengthUnit.INCH);
		double backToFeet = Length.convert(toInches, LengthUnit.INCH, LengthUnit.FEET);
	...
	public void testConversion_ZeroValue() {
		assertEquals(0.0, Length.convert(0.0, LengthUnit.FEET, LengthUnit.INCH), EPSILON);
	}
	...
	public void testConversion_NaNOrInfinite_Throws() {
		...
		assertThrows(IllegalArgumentException.class,
				() -> Length.convert(Double.POSITIVE_INFINITY, LengthUnit.FEET, LengthUnit.INCH));

		assertThrows(IllegalArgumentException.class,
				() -> Length.convert(Double.NEGATIVE_INFINITY, LengthUnit.FEET, LengthUnit.INCH));
	}

	@Test
	public void testConversion_LargeValue() {
		assertEquals(1200000.0, Length.convert(100000.0, LengthUnit.FEET, LengthUnit.INCH), EPSILON);
	}

	@Test
	public void testConversion_SmallValue() {
		assertEquals(0.393701, Length.convert(1.0, LengthUnit.CENTIMETERS, LengthUnit.INCH), EPSILON);
	}
}